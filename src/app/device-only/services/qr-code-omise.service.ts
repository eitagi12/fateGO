...
export class QrCodeOmiseService {
  ...
  createOrderInstallment(params: Object): Promise<any> {
    return this.http.post('/api/payments/super-duper/create-order-installment', params).toPromise();
  }
