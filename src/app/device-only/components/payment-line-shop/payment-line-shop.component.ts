...
@Component({
  selector: 'app-payment-line-shop',
  templateUrl: './payment-line-shop.component.html',
  styleUrls: ['./payment-line-shop.component.scss']
})
export class PaymentLineShopComponent implements OnInit {
