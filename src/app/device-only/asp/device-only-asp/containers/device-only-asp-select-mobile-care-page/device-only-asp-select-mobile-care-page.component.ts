...
import { ROUTE_DEVICE_ONLY_ASP_SUMMARY_PAGE, ROUTE_DEVICE_ONLY_ASP_SELECT_PAYMENT_AND_RECEIPT_INFORMATION_PAGE } from '../../constants/route-path.constant';
...
export class DeviceOnlyAspSelectMobileCarePageComponent implements OnInit, OnDestroy {
  ...
  public onBack(): void {
    this.router.navigate([ROUTE_DEVICE_ONLY_ASP_SELECT_PAYMENT_AND_RECEIPT_INFORMATION_PAGE]);
  }
