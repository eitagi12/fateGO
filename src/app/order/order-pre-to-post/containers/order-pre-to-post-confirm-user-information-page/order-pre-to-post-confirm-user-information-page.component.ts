...
@Component({
  ...
  templateUrl: './order-pre-to-post-confirm-user-information-page.component.html',
  styleUrls: ['./order-pre-to-post-confirm-user-information-page.component.scss']
})
  ...
  initBillingInfo() {
    ...
    this.billingInfo = {
      ...
      billingCycle: {
        ...
        onEdit: () => {
          this.router.navigate([ROUTE_ORDER_PRE_TO_POST_EBILLING_PAGE]);
        },
        onDelete: () => {
