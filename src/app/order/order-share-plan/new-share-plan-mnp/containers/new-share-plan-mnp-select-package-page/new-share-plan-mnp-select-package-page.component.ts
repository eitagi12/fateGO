...
import { ROUTE_NEW_SHARE_PLAN_MNP_VERIFY_INSTANT_SIM_PAGE, ROUTE_NEW_SHARE_PLAN_MNP_NETWORK_TYPE_PAGE, ROUTE_NEW_SHARE_PLAN_MNP_VERIFY_BY_PATTERN_PAGE } from '../../constants/route-path.constant';
...
export class NewSharePlanMnpSelectPackagePageComponent implements OnInit, OnDestroy {
