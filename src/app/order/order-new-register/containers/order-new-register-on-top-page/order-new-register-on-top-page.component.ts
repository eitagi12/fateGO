...
@Component({
  selector: 'app-order-new-register-on-top-page',
  templateUrl: './order-new-register-on-top-page.component.html',
  styleUrls: ['./order-new-register-on-top-page.component.scss']
})
