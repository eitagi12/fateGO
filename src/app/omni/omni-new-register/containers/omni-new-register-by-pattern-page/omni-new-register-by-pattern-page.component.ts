...
@Component({
  selector: 'app-omni-new-register-by-pattern-page',
  templateUrl: './omni-new-register-by-pattern-page.component.html',
  styleUrls: ['./omni-new-register-by-pattern-page.component.scss']
})
export class OmniNewRegisterByPatternPageComponent implements OnInit, OnDestroy {
