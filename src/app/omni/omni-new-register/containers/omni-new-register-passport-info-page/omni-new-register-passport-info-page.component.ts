...
import { ROUTE_OMNI_NEW_REGISTER_FACE_CAPTURE_PAGE, ROUTE_OMNI_NEW_REGISTER_VERIFY_DOCUMENT_PAGE } from '../../constants/route-path.constant';
...
@Component({
  selector: 'app-omni-new-register-passport-info-page',
  templateUrl: './omni-new-register-passport-info-page.component.html',
  styleUrls: ['./omni-new-register-passport-info-page.component.scss']
})
export class OmniNewRegisterPassportInfoPageComponent implements OnInit, OnDestroy, OnChanges {
