...
import {
  ROUTE_OMNI_NEW_REGISTER_ON_TOP_PAGE, ROUTE_OMNI_NEW_REGISTER_FACE_CONFIRM_PAGE
...
@Component({
  selector: 'app-omni-new-register-one-love-page',
  templateUrl: './omni-new-register-one-love-page.component.html',
  styleUrls: ['./omni-new-register-one-love-page.component.scss']
})
export class OmniNewRegisterOneLovePageComponent implements OnInit, OnDestroy {
