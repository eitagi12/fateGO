...
@Component({
  selector: 'app-omni-new-register-confirm-user-information-page',
  templateUrl: './omni-new-register-confirm-user-information-page.component.html',
  styleUrls: ['./omni-new-register-confirm-user-information-page.component.scss'],
})
export class OmniNewRegisterConfirmUserInformationPageComponent implements OnInit, OnDestroy {
