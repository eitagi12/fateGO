...
import { ROUTE_OMNI_BLOCK_CHAIN_FACE_CAPTURE_PAGE, ROUTE_OMNI_BLOCK_CHAIN_RESULT_PAGE, ROUTE_OMNI_BLOCK_CHAIN_FACE_CONFIRM_PAGE, ROUTE_OMNI_BLOCK_CHAIN_FACE_COMPARE_PAGE } from '../../constants/route-path.constant';
