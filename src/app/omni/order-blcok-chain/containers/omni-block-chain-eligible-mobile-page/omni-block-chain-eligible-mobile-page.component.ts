...
import { ROUTE_OMNI_BLOCK_CHAIN_VALIDATE_CUSTOMER_ID_CARD_PAGE, ROUTE_OMNI_BLOCK_CHAIN_LOW_PAGE } from '../../constants/route-path.constant';
const Moment = moment;
...
export class OmniBlockChainEligibleMobilePageComponent implements OnInit, OnDestroy {
  ...
  onBack(): void {
    this.router.navigate([ROUTE_OMNI_BLOCK_CHAIN_VALIDATE_CUSTOMER_ID_CARD_PAGE]);
  }
