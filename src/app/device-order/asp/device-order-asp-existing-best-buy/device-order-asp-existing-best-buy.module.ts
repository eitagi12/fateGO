...
@NgModule({
  ...
  declarations: [DeviceOrderAspExistingBestBuyCheckOutPageComponent,
    ...
    DeviceOrderAspExistingBestBuyCustomerProfilePageComponent,
    DeviceOrderAspExistingBestBuyEligibleMobilePageComponent,
    DeviceOrderAspExistingBestBuyIdcardCaptureRepiPageComponent,
    DeviceOrderAspExistingBestBuyMobileCareAvailablePageComponent,
    DeviceOrderAspExistingBestBuyMobileCarePageComponent,
    DeviceOrderAspExistingBestBuyMobileDetailPageComponent,
    DeviceOrderAspExistingBestBuyOtpPageComponent,
    DeviceOrderAspExistingBestBuyPaymentDetailPageComponent,
    DeviceOrderAspExistingBestBuyQrCodePaymentGeneratorPageComponent,
    DeviceOrderAspExistingBestBuyQrCodeQueuePageComponent,
    DeviceOrderAspExistingBestBuyQrCodeQueueSummaryPageComponent,
    DeviceOrderAspExistingBestBuyQrCodeSummaryPageComponent,
    DeviceOrderAspExistingBestBuyQueuePageComponent,
    DeviceOrderAspExistingBestBuyResultPageComponent,
    DeviceOrderAspExistingBestBuySummaryPageComponent,
    DeviceOrderAspExistingBestBuyValidateCustomerIdCardPageComponent,
    DeviceOrderAspExistingBestBuyValidateCustomerIdCardRepiPageComponent,
    DeviceOrderAspExistingBestBuyValidateCustomerPageComponent,
    DeviceOrderAspExistingBestBuyValidateCustomerRepiPageComponent
  ]
})
export class DeviceOrderAspExistingBestBuyModule { }
