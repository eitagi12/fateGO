...
import {
  ...
  ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_PERSO_SIM_MEMBER_PAGE
...
export class NewRegisterMnpPersoSimMasterPageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    ...
    this.router.navigate([ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_PERSO_SIM_MEMBER_PAGE]);
  }
