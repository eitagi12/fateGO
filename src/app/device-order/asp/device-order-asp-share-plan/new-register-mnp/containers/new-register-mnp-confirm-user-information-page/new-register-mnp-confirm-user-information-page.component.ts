...
import {
  ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_EDIT_BILLING_ADDRESS_PAGE,
  ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_EBILLING_PAGE,
  ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_SELECT_REASON_PAGE,
  ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_MOBILE_CARE_PAGE
...
export class NewRegisterMnpConfirmUserInformationPageComponent implements OnInit, OnDestroy {
  ...
  initBillingInfo(): void {
    ...
    this.billingInfo = {
      ...
      billingAddress: {
        ...
        isEdit: !(!!mergeBilling),
        onEdit: () => {
          this.router.navigate([ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_EDIT_BILLING_ADDRESS_PAGE]);
        }
      },
      billingCycle: {
        text: '-',
        ...
        onEdit: () => {
          this.router.navigate([ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_EBILLING_PAGE]);
        },
        onDelete: () => {
  ...
  onBack(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_SELECT_REASON_PAGE]);
  }
  ...
  onNext(): void {
    ...
    this.router.navigate([ROUTE_DEVICE_ORDER_ASP_SHARE_PLAN_NEW_REGISTER_MNP_MOBILE_CARE_PAGE]);
  }
