...
import {
  ...
  ROUTE_DEVICE_ORDER_TELEWIZ_SHARE_PLAN_NEW_REGISTER_MNP_QUEUE_PAGE
...
export class NewRegisterMnpAggregatePageComponent implements OnInit {
  ...
  onNext(): void {
    ...
    if (payment.paymentType === 'QR_CODE' || advancePayment.paymentType === 'QR_CODE') {
      ...
      this.router.navigate([ROUTE_DEVICE_ORDER_TELEWIZ_SHARE_PLAN_NEW_REGISTER_MNP_QUEUE_PAGE]);
    }
  }
