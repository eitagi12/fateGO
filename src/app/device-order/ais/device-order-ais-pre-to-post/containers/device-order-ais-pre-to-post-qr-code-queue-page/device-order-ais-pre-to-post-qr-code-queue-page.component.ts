...
import { ROUTE_DEVICE_ORDER_AIS_PRE_TO_POST_RESULT_PAGE, ROUTE_DEVICE_ORDER_AIS_PRE_TO_POST_QR_CODE_RESULT_PAGE } from '../../constants/route-path.constant';
...
export class DeviceOrderAisPreToPostQrCodeQueuePageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    ...
    this.queuePageService.getQueueQmatic(this.queueFrom.value.mobileNo)
      ...
      .then(() => {
        this.router.navigate([ROUTE_DEVICE_ORDER_AIS_PRE_TO_POST_QR_CODE_RESULT_PAGE]);
      })
