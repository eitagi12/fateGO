...
@Component({
  ...
  templateUrl: './device-order-ais-pre-to-post-ebilling-address-page.component.html',
  styleUrls: ['./device-order-ais-pre-to-post-ebilling-address-page.component.scss']
})
