...
@Component({
  selector: 'app-device-order-ais-pre-to-post-omise-result-page',
  templateUrl: './device-order-ais-pre-to-post-omise-result-page.component.html',
  styleUrls: ['./device-order-ais-pre-to-post-omise-result-page.component.scss']
})
export class DeviceOrderAisPreToPostOmiseResultPageComponent implements OnInit {
