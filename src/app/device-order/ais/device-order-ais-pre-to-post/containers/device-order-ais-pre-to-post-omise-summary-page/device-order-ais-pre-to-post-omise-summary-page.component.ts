...
import { ROUTE_DEVICE_ORDER_AIS_PRE_TO_POST_OMISE_GENERATOR_PAGE, ROUTE_DEVICE_ORDER_AIS_PRE_TO_POST_AGGREGATE_PAGE } from '../../constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-pre-to-post-omise-summary-page',
  templateUrl: './device-order-ais-pre-to-post-omise-summary-page.component.html',
  styleUrls: ['./device-order-ais-pre-to-post-omise-summary-page.component.scss']
})
export class DeviceOrderAisPreToPostOmiseSummaryPageComponent implements OnInit, OnDestroy {
