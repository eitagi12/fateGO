...
const routes: Routes = [
  ...
  { path: 'id-card-capture', component: DeviceOrderAisPreToPostIdCardCapturePageComponent },
  ...
  { path: 'validate-customer-repi', component: DeviceOrderAisPrtToPostValidateCustomerRepiPageComponent },
  ...
  { path: 'id-card-capture-repi', component: DeviceOrderAisPreToPostIdCardCaptureRepiPageComponent },
