...
import { HomeService, AlertService, TokenService, CustomerAddress, User } from 'mychannel-shared-libs';
...
import { ROUTE_DEVICE_ORDER_AIS_EXISTING_GADGET_SUMMARY_PAGE } from '../../constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-existing-gadget-eshipping-address-page',
  templateUrl: './device-order-ais-existing-gadget-eshipping-address-page.component.html',
  styleUrls: ['./device-order-ais-existing-gadget-eshipping-address-page.component.scss']
})
export class DeviceOrderAisExistingGadgetEshippingAddressPageComponent implements OnInit, OnDestroy {
