...
@Component({
  ...
  templateUrl: './device-order-ais-device-omise-queue-page.component.html',
  styleUrls: ['./device-order-ais-device-omise-queue-page.component.scss']
})
export class DeviceOrderAisDeviceOmiseQueuePageComponent implements OnInit, OnDestroy {
