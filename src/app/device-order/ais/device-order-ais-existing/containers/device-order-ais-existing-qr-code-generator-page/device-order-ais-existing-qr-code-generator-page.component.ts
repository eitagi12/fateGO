...
import { ROUTE_DEVICE_ORDER_AIS_EXISTING_QR_CODE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_EXISTING_QR_CODE_QUEUE_PAGE, ROUTE_DEVICE_ORDER_AIS_EXISTING_QR_CODE_ERROR_PAGE } from '../../constants/route-path.constant';
import * as moment from 'moment';
import { QrCodePageService } from 'src/app/device-order/services/qr-code-page.service';
@Component({
  selector: 'app-device-order-ais-existing-qr-code-generator-page',
  templateUrl: './device-order-ais-existing-qr-code-generator-page.component.html',
  styleUrls: ['./device-order-ais-existing-qr-code-generator-page.component.scss']
})
export class DeviceOrderAisExistingQrCodeGeneratorPageComponent implements OnInit, OnDestroy {
