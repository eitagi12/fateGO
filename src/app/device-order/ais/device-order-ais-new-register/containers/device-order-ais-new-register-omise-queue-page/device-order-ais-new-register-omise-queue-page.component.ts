...
import { ROUTE_DEVICE_ORDER_AIS_NEW_REGISTER_OMISE_RESULT_PAGE } from '../../constants/route-path.constant';
...
@Component({
  ...
  templateUrl: './device-order-ais-new-register-omise-queue-page.component.html',
  styleUrls: ['./device-order-ais-new-register-omise-queue-page.component.scss']
})
export class DeviceOrderAisNewRegisterOmiseQueuePageComponent implements OnInit, OnDestroy {
