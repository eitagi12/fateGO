...
@Component({
  selector: 'app-device-order-ais-existing-best-buy-shop-omise-result-page',
  templateUrl: './device-order-ais-existing-best-buy-shop-omise-result-page.component.html',
  styleUrls: ['./device-order-ais-existing-best-buy-shop-omise-result-page.component.scss']
})
export class DeviceOrderAisExistingBestBuyShopOmiseResultPageComponent implements OnInit {
