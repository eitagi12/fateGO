...
@Component({
  selector: 'app-device-order-ais-existing-best-buy-shop-qr-code-summary-page',
  templateUrl: './device-order-ais-existing-best-buy-shop-qr-code-summary-page.component.html',
  styleUrls: ['./device-order-ais-existing-best-buy-shop-qr-code-summary-page.component.scss']
})
export class DeviceOrderAisExistingBestBuyShopQrCodeSummaryPageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_QR_CODE_GENERATOR_PAGE]);
  }
