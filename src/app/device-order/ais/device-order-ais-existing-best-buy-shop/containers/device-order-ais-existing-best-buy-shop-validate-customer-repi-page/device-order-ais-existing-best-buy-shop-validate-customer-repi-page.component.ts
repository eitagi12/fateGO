...
import { ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_VALIDATE_CUSTOMER_ID_CARD_RPI_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_MOBILE_DETAIL_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_CUSTOMER_INFO_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_PAYMENT_DETAIL_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_CUSTOMER_PROFILE_PAGE } from '../../constants/route-path.constant';
import { AbstractControl, ValidationErrors } from '@angular/forms';

@Component({
  selector: 'app-device-order-ais-existing-best-buy-shop-validate-customer-repi-page',
  templateUrl: './device-order-ais-existing-best-buy-shop-validate-customer-repi-page.component.html',
  styleUrls: ['./device-order-ais-existing-best-buy-shop-validate-customer-repi-page.component.scss']
})
export class DeviceOrderAisExistingBestBuyShopValidateCustomerRepiPageComponent implements OnInit, OnDestroy {
