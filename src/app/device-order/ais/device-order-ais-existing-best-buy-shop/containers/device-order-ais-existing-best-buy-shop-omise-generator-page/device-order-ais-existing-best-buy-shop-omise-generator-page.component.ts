...
import { ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_OMISE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_OMISE_QUEUE_PAGE } from 'src/app/device-order/ais/device-order-ais-existing-best-buy-shop/constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-existing-best-buy-shop-omise-generator-page',
  templateUrl: './device-order-ais-existing-best-buy-shop-omise-generator-page.component.html',
  styleUrls: ['./device-order-ais-existing-best-buy-shop-omise-generator-page.component.scss']
})
export class DeviceOrderAisExistingBestBuyShopOmiseGeneratorPageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_BEST_BUY_SHOP_OMISE_QUEUE_PAGE]);
  }
