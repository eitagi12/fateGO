...
import { ROUTE_DEVICE_ORDER_AIS_EXISTING_OMISE_QUEUE_PAGE, ROUTE_DEVICE_ORDER_AIS_EXISTING_OMISE_SUMMARY_PAGE } from 'src/app/device-order/ais/device-order-ais-existing/constants/route-path.constant';
...
export class DeviceOrderAisExistingPrepaidHotdealOmiseGeneratorPageComponent implements OnInit, OnDestroy {
