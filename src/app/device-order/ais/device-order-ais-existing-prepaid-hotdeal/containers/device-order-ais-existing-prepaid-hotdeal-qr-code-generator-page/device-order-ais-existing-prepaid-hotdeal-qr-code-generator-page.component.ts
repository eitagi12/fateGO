...
import { ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_QUEUE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_QUEUE_PAGE, ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_ERROR_PAGE } from '../../constants/route-path.constant';
...
@Component({
  selector: 'app-device-order-ais-existing-prepaid-hotdeal-qr-code-generator-page',
  templateUrl: './device-order-ais-existing-prepaid-hotdeal-qr-code-generator-page.component.html',
  styleUrls: ['./device-order-ais-existing-prepaid-hotdeal-qr-code-generator-page.component.scss']
})
export class DeviceOrderAisExistingPrepaidHotdealQrCodeGeneratorPageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_QUEUE_PAGE]);
  }
  ...
  goToMpayErrorPage(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_PREPAID_HOTDEAL_QR_CODE_ERROR_PAGE]);
  }
