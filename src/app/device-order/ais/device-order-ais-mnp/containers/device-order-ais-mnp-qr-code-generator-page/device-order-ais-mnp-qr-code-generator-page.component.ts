...
import { QRodePrePostMpayModel } from '../../../device-order-ais-new-register/containers/device-order-ais-new-register-qr-code-generator-page/device-order-ais-new-register-qr-code-generator-page.component';
...
import { ROUTE_DEVICE_ORDER_AIS_MNP_QR_CODE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_QR_CODE_QUEUE_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_QR_CODE_ERROR_PAGE } from '../../constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-mnp-qr-code-generator-page',
  templateUrl: './device-order-ais-mnp-qr-code-generator-page.component.html',
  styleUrls: ['./device-order-ais-mnp-qr-code-generator-page.component.scss']
})
export class DeviceOrderAisMnpQrCodeGeneratorPageComponent implements OnInit, OnDestroy {
  ...
  goToMpayErrorPage(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_MNP_QR_CODE_ERROR_PAGE]);
  }
