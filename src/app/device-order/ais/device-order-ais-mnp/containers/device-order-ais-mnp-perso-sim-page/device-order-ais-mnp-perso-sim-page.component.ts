...
import { OptionPersoSim } from '../../../device-order-ais-new-register/containers/device-order-ais-new-register-perso-sim-page/device-order-ais-new-register-perso-sim-page.component';
...
import { ROUTE_DEVICE_ORDER_AIS_MNP_BY_PATTERN_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_AGREEMENT_SIGN_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_FACE_CAPTURE_PAGE } from '../../constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-mnp-perso-sim-page',
  templateUrl: './device-order-ais-mnp-perso-sim-page.component.html',
  styleUrls: ['./device-order-ais-mnp-perso-sim-page.component.scss']
})
export class DeviceOrderAisMnpPersoSimPageComponent implements OnInit, OnDestroy {
