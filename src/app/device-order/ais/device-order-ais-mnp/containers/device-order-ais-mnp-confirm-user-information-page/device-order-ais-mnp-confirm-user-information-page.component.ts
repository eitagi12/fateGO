...
import { ConfirmCustomerInfo, BillingInfo, MailBillingInfo, TelNoBillingInfo, ShoppingCart, HomeService, AlertService, Utils, BillingSystemType } from 'mychannel-shared-libs';
...
@Component({
  ...
  templateUrl: './device-order-ais-mnp-confirm-user-information-page.component.html',
  styleUrls: ['./device-order-ais-mnp-confirm-user-information-page.component.scss']
})
export class DeviceOrderAisMnpConfirmUserInformationPageComponent implements OnInit, OnDestroy {
  ...
  initBillingInfo(): void {
    ...
    this.billingInfo = {
      ...
      billingMethod: {
        ...
        onEdit: () => {
          // this.router.navigate([ROUTE_DEVICE_ORDER_AIS_MNP_MERGE_BILLING_PAGE]);
        },
        onDelete: () => {
      ...
      billingAddress: {
        ...
        onEdit: () => {
          this.router.navigate([ROUTE_DEVICE_ORDER_AIS_MNP_EDIT_BILLING_ADDRESS_PAGE]);
        }
      },
      billingCycle: {
        text: '-',
        ...
        onEdit: () => {
          this.router.navigate([ROUTE_DEVICE_ORDER_AIS_MNP_EBILLING_PAGE]);
        },
        onDelete: () => {
