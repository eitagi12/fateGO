...
import { ShoppingCart, MobileNoCondition, MobileNo, User, HomeService, TokenService, PageLoadingService, AlertService } from 'mychannel-shared-libs';
import { Transaction } from 'src/app/shared/models/transaction.model';
import { Router } from '@angular/router';
import { TransactionService } from 'src/app/shared/services/transaction.service';
import { ShoppingCartService } from 'src/app/device-order/services/shopping-cart.service';
import { ROUTE_DEVICE_ORDER_AIS_MNP_SELECT_PACKAGE_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_SELECT_NUMBER_PAGE } from '../../constants/route-path.constant';
import { HttpClient } from '@angular/common/http';

@Component({
  selector: 'app-device-order-ais-mnp-by-pattern-page',
  templateUrl: './device-order-ais-mnp-by-pattern-page.component.html',
  styleUrls: ['./device-order-ais-mnp-by-pattern-page.component.scss']
})
export class DeviceOrderAisMnpByPatternPageComponent implements OnInit, OnDestroy {
