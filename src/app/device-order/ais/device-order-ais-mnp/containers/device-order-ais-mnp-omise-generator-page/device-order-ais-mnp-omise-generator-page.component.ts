...
import { ROUTE_DEVICE_ORDER_AIS_MNP_OMISE_QUEUE_PAGE, ROUTE_DEVICE_ORDER_AIS_MNP_OMISE_SUMMARY_PAGE } from 'src/app/device-order/ais/device-order-ais-mnp/constants/route-path.constant';
...
export class DeviceOrderAisMnpOmiseGeneratorPageComponent implements OnInit, OnDestroy {
