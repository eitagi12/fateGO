...
import { ROUTE_DEVICE_ORDER_AIS_BEST_BUY_OMISE_SUMMARY_PAGE, ROUTE_DEVICE_ORDER_AIS_BEST_BUY_OMISE_QUEUE_PAGE } from 'src/app/device-order/ais/device-order-ais-existing-best-buy/constants/route-path.constant';

@Component({
  selector: 'app-device-order-ais-existing-best-buy-omise-generator-page',
  templateUrl: './device-order-ais-existing-best-buy-omise-generator-page.component.html',
  styleUrls: ['./device-order-ais-existing-best-buy-omise-generator-page.component.scss']
})
export class DeviceOrderAisExistingBestBuyOmiseGeneratorPageComponent implements OnInit, OnDestroy {
  ...
  onNext(): void {
    this.router.navigate([ROUTE_DEVICE_ORDER_AIS_BEST_BUY_OMISE_QUEUE_PAGE]);
  }
